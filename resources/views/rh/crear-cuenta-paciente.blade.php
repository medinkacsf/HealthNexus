...
<head>
    ...
    <title>Nueva Cuenta Paciente - RRHH</title>
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .btn-logout{background:rgba(255,255,255,0.15)}.btn-green{background:var(--green-600)}.btn-dark{background:var(--neutral-600)}.btn-outline{background:transparent;border:1.5px solid var(--neutral-200);color:var(--neutral-600)}
...
<body>
    <div class="header">
        <h1>💳 Nueva Cuenta de Paciente</h1>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/rh/cuentas-pacientes/guardar">
                        @csrf
                        <div class="form-group">
                            <label>Nombre del Paciente *</label>
                            <input type="text" name="paciente_nombre" value="{{ old('paciente_nombre') }}" placeholder="Nombre completo" required>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="medico_id">
                                    ...
                                    <option value="1" {{ old('medico_id')==1?'selected':'' }}>Dr. Jefe Martinez</option>
                                    <option value="4" {{ old('medico_id')==4?'selected':'' }}>Medico Cristian</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>ID Expediente</label>
                                <input type="number" name="expediente_id" value="{{ old('expediente_id') }}" placeholder="Opcional">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label> Cargo Inicial</label>
                                <input type="number" step="0.01" min="0" name="total_cargo" value="{{ old('total_cargo', 0) }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-actions">
                            <a href="/rh/cuentas-pacientes" class="btn btn-outline">Cancelar</a>
